...
public interface IDealer
{
    ...
    /// </remarks>
    Task<List<Cards>> ShuffleCutDeal(Cards deck, int numHands, CancellationToken cancellationToken);

    /// <remarks>
    /// This may or may not mutate the supplied <paramref name="deck"/>.
    /// </remarks>
    Task<Cards> Shuffle(Cards deck, CancellationToken cancellationToken);

    /// <remarks>
    /// This may or may not mutate the supplied <paramref name="deck"/>.
    /// </remarks>
    Task<Cards> Cut(Cards deck, CancellationToken cancellationToken, int minNumCardsFromEdges = 1);

    Task<List<Cards>> Deal(Cards deck, int numHands, CancellationToken cancellationToken);
}
...
{
    public async Task<List<Cards>> ShuffleCutDeal(Cards deck, int numHands, CancellationToken cancellationToken)
    {
    ...
    public async Task<Cards> Shuffle(Cards deck, CancellationToken cancellationToken)
    {
    ...
    public async Task<Cards> Cut(Cards deck, CancellationToken cancellationToken, int minNumCardsFromEdges = 1)
    {
    ...
    public async Task<List<Cards>> Deal(Cards deck, int numHands, CancellationToken cancellationToken)
    {
